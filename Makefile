PRODUCT_NAME       = KathleenTynan-BitmojiJump
SOURCES            = myLib.c main.c sprites.c text.c collisions.c background.c platforms.c start.c sound.c clouds.c instructions.c songs.c endScreens.c pause.c
DKPATH             = /opt/devkitARM/bin
CCPATH             = /usr/bin
VBASIM             = wine /Users/kathleentynan/Documents/Spring2017/CS2261/vba.exe
FIND               = find
COPY               = cp -r
